...
class Login extends Component {
  ...
  loginClickHandler = () => {
    ...
    if (
      this.state.username === "arunsebin" &&
      this.state.password === "school123"
    ) {
      sessionStorage.setItem("username", "arunsebin");
      sessionStorage.setItem(
        "access-token",
        "IGQVJXUWQwUi1nLTNnVFo2d1IyY2JXa0cxb0x1YnZAseVNFSDMxbWRlZAUdNTW10TGRYazdoQzYyVDBFbFlWb3VwS2E0aW9sSWhvaUd5QVNmMzg3S1lJQW83aERjRzBoNV9MT2ZA3T0phQkJFd0lSSk1nbEZApcTBFMjhLRUZAz"
      );
